...
<div class="layui-layout layui-layout-admin kit-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">koko</div>
    <div class="layui-logo kit-logo-mobile"></div>
    <div class="layui-hide-xs">
    <ul class="layui-nav layui-layout-left kit-nav">
      <li class="layui-nav-item"><a href="/note">我的笔记</a></li>
...
<#macro tree data start end>
  ...
  <#list data as child>
    ...
    <#else>
      <dd>
        <a href="javascript:;" kit-target data-options="{url:'${re.contextPath}/${child.url}',icon:'${child.icon}',title:'${child.name}',id:'${child.num?c}'}">
...
<@tree data=menu start="start" end="end"/>
  <div class="layui-body" style="bottom:0;" id="container">
    <!-- 内容主体区域 -->
